...
namespace App
{
    public class ModelParameters
    {
        ...
        public double? threadWeight; ///Масса нити
        ///Если threadWeight=0 -> масса распределена нормально
        ///Параметры для распределения:
        public double[] threadWeightRasp; ///Коэффициенты распределения массы


        public double threadHiddenLength; ///Длина нити в зажиме
        ...
        public ModelParameters(double? _threadWeigth,
            double[] _threadWeigthRasp,
            ...
            double _clampForce)
        {
            this.threadWeight = _threadWeigth;
